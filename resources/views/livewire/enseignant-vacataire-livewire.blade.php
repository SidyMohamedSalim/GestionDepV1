    ...
    <table class="w-full text-sm text-left">
        ...
        <thead class="text-xs text-white uppercase bg-primary ">
            <tr>
                ...
                <x-table-header fieldname="date_debut" :selectedFieldName="$orderByField"
                    :orderDirection="$orderByDirection">
                    Debut
                </x-table-header>
                <x-table-header fieldname="date_fin" :selectedFieldName="$orderByField"
                    :orderDirection="$orderByDirection">
                    Fin
                </x-table-header>
            ...
            <tr class="border-b odd:bg-white">
                ...
                <td class="flex items-center justify-center gap-4 px-6 py-4">
                    ...
                    <x-modal-alpine title="Suppression" :key="$enseignant->id" name="materiel de {{ $enseignant->id }}">
                        ...
                        <livewire:modals.confirm-delete-modal :elementId="$enseignant->id" routeName='vacataire.destroy'
                            key="delete-{{ $enseignant->id }}" />
                    </x-modal-alpine>
