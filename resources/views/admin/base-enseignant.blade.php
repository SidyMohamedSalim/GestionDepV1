    ...
    <div class="max-w-screen-xl m-10 mx-auto">
        ...
        <div class="flex items-center justify-between my-4">
            <div> <a href="{{ route('enseignant.index') }}" active="request() - > routeIs('enseignant.index')"
                    class='inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest @if (request()->routeIs('
                    enseignant.index')) text-white bg-primary @else @endif uppercase transition duration-150 ease-in-out
                    border border-transparent rounded-md hover:bg-primary focus:bg-primary active:bg-primary
                ...
                <a href="{{ route('vacataire.index') }}" active="request() - > routeIs('enseignant.index')"
                    class='inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest @if (request()->routeIs('
                    vacataire.index')) text-white bg-primary @else @endif uppercase transition duration-150 ease-in-out
                    border border-transparent rounded-md hover:bg-primary focus:bg-primary active:bg-primary
                    focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2'>
