@props(['name'=>"salu", 'show' => false, 'maxWidth' => '2xl'])
...
<div x-data="{
    ...
    <button type="button" class="text-red-500" @click="show = true">Open Modal</button>
    <div x-show="show" class="fixed inset-0 transition-all transform" x-on:click="show = false"
        ...
        <div class="absolute inset-0 bg-gray-500 opacity-75">Hello</div>
    </div>
