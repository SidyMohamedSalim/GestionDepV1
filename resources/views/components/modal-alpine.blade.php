<div x-data="{ 'showModal': false }" @keydown.escape="showModal = false">
    ...
    <div class="fixed inset-0 z-30 flex items-center justify-center overflow-auto bg-black bg-opacity-50"
        ...
        <div class="max-w-3xl px-6 py-4 mx-auto text-left bg-white rounded shadow-lg" @click.away="showModal = false"
            ...
            <!-- content -->
            <div>Content goes here Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas ad enim sapiente
                exercitationem fugit quae labore molestias, ab illo dicta eveniet nobis, provident soluta possimus, vel
                doloremque repellendus nihil. Ab.</div>
        </div>
    </div>
</div>